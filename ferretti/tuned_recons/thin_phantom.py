...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 24 11:21:07 2025
...
subvol_raw = vol_raw[:,(Nx-Ny)//2:(Nx+Ny)//2,:] # I think to make volume smaller in y. Ignoting for now 
...
np.save('noisy_projection_data_thin_phantom', data)
