...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 23 13:36:15 2025
...
COOLDOWN = 20  # @param{type:"integer"}
...
#in_rand_array[:,:,:,0] = np.random.rand(64,30,64)*10**-8 #Starting intial guess set to correct order of magnitude
#in_rand_array[:,:,:,1] = np.random.rand(64,30,64)*10**-6 #Starting intial guess set to correct order of magnitude
