...
for i in range(len(up_samp_facs)):
    ...
    propagator_transfer = cx.compute_transfer_propagator(pad(field, up_samp_fac*N_pad, cval=cval), phantom_dx/up_samp_fac, n_medium)
    exit_field = cx.multislice_thick_sample(field, obj_beta, obj_delta, n, phantom_dx/up_samp_fac, up_samp_fac*N_pad, \
